...
namespace term2project.Controllers
{
    ...
    public class CarsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,DepositAmount,IsAuto,ImageLink")] Cars cars)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,DepositAmount,IsAuto,ImageLink")] Cars cars)
        {
            if (id != cars.ID)
            {
                return NotFound();
